...
/**
 * Represents a tech.tablesaw.chart in some form.
 * A tech.tablesaw.chart can be exported into various formats using the Plot class e.g:
 * <code>
 * AreaChart tech.tablesaw.chart = new AreaChart(table);
 * inout.view(Plot.jfx(tech.tablesaw.chart))
 * </code>
 */
