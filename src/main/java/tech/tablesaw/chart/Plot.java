...
public class Plot {
   ...
   * into a WebView or browser. This is useful if the jfx method cannot handle the tech.tablesaw.chart.
   * @param chart the tech.tablesaw.chart to render
   * @return a String containing the html for the tech.tablesaw.chart
   */
  ...
  /**
   * You can use this to show it using tech.tablesaw.plotly.Plot.show(jsPlot(tech.tablesaw.chart)) or
   * inout.viewHtml(jsPlot(tech.tablesaw.chart).asJavaScript("divName"))
   * @param chart the tech.tablesaw.chart to render
